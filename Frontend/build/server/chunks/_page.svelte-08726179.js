import { c as create_ssr_component, v as validate_component, b as get_current_component, s as setContext, e as escape, d as add_styles, m as missing_component, g as getContext, a as add_attribute, f as each, h as set_current_component, i as current_component, j as createEventDispatcher } from './ssr-7fae8f6a.js';
import { s as subscribe, n as noop, i as identity, g as get_store_value, a as is_function, r as run_all, b as set_store_value } from './utils-67317de5.js';
import { w as writable, d as derived, r as readable } from './index-c4d8ba05.js';
...
const Day$1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${escape($theme.day, true) + " " + escape($theme.weekdays?.[date.getUTCDay()], true) + escape(isToday ? " " + $theme.today : "", true) + escape(highlight ? " " + $theme.highlight : "", true)}"${add_attribute("this", el, 0)}><div${add_attribute("class", $theme.bgEvents, 0)}>${each(bgChunks, (chunk) => {
    return `${validate_component(Event$1, "Event").$$render($$result, { date, chunk }, {}, {})}`;
  })}</div> <div${add_attribute("class", $theme.events, 0)}> ${iChunks[1] ? `${validate_component(Event$1, "Event").$$render($$result, { date, chunk: iChunks[1] }, {}, {})}` : ``} ${each(chunks, (chunk) => {
    return `${validate_component(Event$1, "Event").$$render($$result, { date, chunk }, {}, {})}`;
  })}  ${iChunks[0] && !iChunks[0].event.allDay ? `${validate_component(Event$1, "Event").$$render($$result, { date, chunk: iChunks[0] }, {}, {})}` : ``}</div> <div${add_attribute("class", $theme.extra, 0)}> ${$nowIndicator && isToday ? `${validate_component(NowIndicator, "NowIndicator").$$render($$result, {}, {}, {})}` : ``}</div></div>`;
});
...
const View = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div${add_attribute("class", $theme.header, 0)}>${validate_component(Section, "Section").$$render($$result, {}, {}, {
    ...
    default: () => {
      return `${validate_component(Week, "Week").$$render($$result, { dates: $_viewDates }, {}, {})}`;
    }
  })} <div${add_attribute("class", $theme.hiddenScroll, 0)}></div></div></div>` : ``} ${validate_component(Body, "Body").$$render($$result, {}, {}, {
    default: () => {
      return `${each($_viewDates, (date) => {
        return `${validate_component(Day$1, "Day").$$render($$result, { date }, {}, {})}`;
      })}`;
    }
  })}`;
});
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="flex flex-col items-start mt-7 mb-36 text-black"><h1 class="text-4xl font-bold my-10 ml-5" data-svelte-h="svelte-1a1o1c7">MI AGENDA</h1> <div class="flex justify-center items-center w-full pr-10 gap-10 mx-5"> <div class="justify-center items-center w-full"><div class="bg-white ec-auto-dark text-black">${validate_component(Calendar, "Calendar").$$render($$result, { plugins, options }, {}, {})} </div></div></div></div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-08726179.js.map
